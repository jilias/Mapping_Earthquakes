...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  function styleEarthquake(feature) {
    return {
      opacity: 1,
      fillOpacity: 1,
      fillColor: getColorearthquake(feature.properties.mag),
      color: "violet",
      radius: getRadius(feature.properties.mag),
      stroke: true,
      weight: 0.5
...
// 5. Change the color function to use three colors for the major earthquakes based on the magnitude of the earthquake.
  function getColorearthquake(magnitude) {
    if (magnitude > 5) {
      return "#ea2c2c";
    }
    if (magnitude > 4) {
...
// 8. Add the major earthquakes layer to the map.
  onEachFeature: function(feature, layer) {
    layer.bindPopup("Magnitude: " + feature.properties.mag + "<br>Location: " + feature.properties.place);}}).addTo(majorEQ);
        majorEQ.addTo(map);
